    ...
    <section className="home-view">
      <div className="home-description">
        <p className="home-description-p">
          ...
          <br></br><br></br>
          <img className="home-image" src={imageOne} alt=""/>
          <br></br><br></br>
          Insert text into the form provided, provide a title for the word cloud, and select from additional style options - once the form is complete, click the "Generate Word Cloud" button to create your word cloud.
          <br></br><br></br>
          <img className="home-image" src={imageTwo} alt=""/>
          <br></br><br></br>
          <img className="home-image" src={imageThree} alt=""/>
          <br></br><br></br>
